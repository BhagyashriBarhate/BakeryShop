...
?>
                    <div class="main-content">
                                ...
                                <center><h3><b>:: View Pastry Products ::</h3></b></center>
                      <table class="table table-bordered table-hover" style="background-color: white;margin-top: 40px;margin-right:300px; ">
           ...
           . "<td>$row[8]</td><td align='center'><img src='{$row[9]}' height='50px' width='50px'></td><td><a href='deleteCake.php?id=$id' class='btn btn-default btn-sm'><i style='color:black;' class='fa fa-trash'></i></a></td>"
...
if(isset($_POST['update'])){
   ...
   // $sql="update product set pname='$name',price='$pricee',shape='$shape',weight='$weight',flavour='$flavour' where id='$id'";
     $sql="update product set pname='$name',price='$pricee',flavour='$flavour' where id='$id'";
