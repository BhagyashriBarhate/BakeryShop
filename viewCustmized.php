                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-block" style="margin-top:100px;">
                                    ...
                                    <div style="margin-bottom:40px;"> <center><h2><b>:: View All Customized product ::</h2></b></center></div>
         <center>
                                        ...
                                        <table id="dataTable"  class="table table-bordered table-hover table-sm">
                                            <thead style="background-color: silver;">
                                                <tr align="center">     
                                                     ...
                                                     <th height="50px;">Products</th>
                                                   <th height="50px;">User Id</th>
                                                   <th height="50px;">Order Date</th>
...
while ($row = mysqli_fetch_array($result)) {
    ...
    echo "<tbody><tr align='center'><td>$row[3]</td><td>$row[1]</td><td>$row[2]</td><td>$row[5]</td></td><td>$row[4]</td><td>$row[7]</td><td><img src='{$row[6]}' height='50px' width='50px'></td><td>$row[8]</td>"
    . "";
    if ($row[8] == 'Approved') {
        //i've taken the toggle button from font awesome

        echo "<td><a class='btn btn-default btn-sm' href='StatusChangeToReject.php?pcid=$row[0]'><i class='fas fa-toggle-on' style='color:green;'></i></td>";
    } else {

        echo "<td><a class='btn btn-default btn-sm' href='StatusChangeToApprove.php?pcid=$row[0]'><i class='fas fa-toggle-off' style='color:green ;'></i></td>";
    }
    
    if ($row[9] == 'Done') {
        //i've taken the toggle button from font awesome

        echo "<td><a class='btn btn-default btn-sm' href='StatusChangeToReject.php?pcid=$row[0]'><i class='fas fa-check' style='color:green;'></i></td>";
    } else {

        echo "<td><a class='btn btn-default btn-sm' href='StatusChangeToApprove.php?pcid=$row[0]'><i class='fas fa-times' style='color:green ;'></i></td>";
    }
    
    if ($row[10] == 'Done') {
        //i've taken the toggle button from font awesome

        echo "<td><a class='btn btn-default btn-sm' href='customizeDeliveryPending.php?pcid=$row[0]'><i class='fas fa-check' style='color:green;'></i></td>";
    } else {

        echo "<td><a class='btn btn-default btn-sm' href='customizeDeliveryDone.php?pcid=$row[0]'><i class='fas fa-times' style='color:green ;'></i></td>";
    }
}
