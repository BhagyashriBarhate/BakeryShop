                ...
                <div class="page-container">
                    ...
                    <div class="container-fluid">
                        <div class="page-title">
                            <center><h1><b>:: All Customer Details ::</b></h1></center>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <div class="table-overflow">
                                            <div id="dt-opt_wrapper" class="dataTables_wrapper no-footer"></div><table id="dt-opt" class="table table-lg table-hover dataTable no-footer" role="grid" aria-describedby="dt-opt_info">
                                                <thead>
                                                    <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="dt-opt" rowspan="1" colspan="1" aria-sort="ascending" aria-label=": activate to sort column descending" style="width: 84px;"></th><th class="sorting" tabindex="0" aria-controls="dt-opt" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending" style="width: 241px;">Name</th><th class="sorting" tabindex="0" aria-controls="dt-opt" rowspan="1" colspan="1" aria-label="Bill Code: activate to sort column ascending" style="width: 92px;">C_Id</th><th class="sorting" tabindex="0" aria-controls="dt-opt" rowspan="1" colspan="1" aria-label="Date: activate to sort column ascending" style="width: 128px;">Email</th><th class="sorting" tabindex="0" aria-controls="dt-opt" rowspan="1" colspan="1" aria-label="Date: activate to sort column ascending" style="width: 128px;">Address</th><th class="sorting" tabindex="0" aria-controls="dt-opt" rowspan="1" colspan="1" aria-label="Amount: activate to sort column ascending" style="width: 111px;">Contact</th><th class="sorting" tabindex="0" aria-controls="dt-opt" rowspan="1" colspan="1" aria-label=": activate to sort column ascending" style="width: 70px;"></th></tr>
                                                </thead>
                                                <tbody> 
                                                ...
                                                <tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                            <div class="list-info mrg-top-10">
                                                                ...
                                                                <div class="info">
                                                                    <span class="title">Hetvi Shah</span>
                                                                    <span class="sub-title">ID 119</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="mrg-top-15">
                                                                <span class="text-info"><b>119</b></span>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="mrg-top-15">
                                                                <span>16mscit119@gmail.com</span>
                                                            </div>
                                                        </td>
                                                         <td>
                                                            <div class="mrg-top-15">
                                                        ...
                                                        <td>
                                                            <div class="mrg-top-15">
                                                                <b class="text-dark font-size-16">9586785956</b>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                            <div class="list-info mrg-top-10">
                                                                ...
                                                                <div class="info">
                                                                    <span class="title">Zinal Patel</span>
                                                                    <span class="sub-title">ID 145</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="mrg-top-15">
                                                                <span class="text-info"><b>145</b></span>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="mrg-top-15">
                                                                <span>16mscit145@gmail.com</span>
                                                            </div>
                                                        </td>
                                                         <td>
                                                            <div class="mrg-top-15">
                                                        ...
                                                        <td>
                                                            <div class="mrg-top-15">
                                                                <b class="text-dark font-size-16">9994526455</b>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="mrg-top-10 text-center">
                                                    ...
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                            <div class="list-info mrg-top-10">
                                                                ...
                                                                <div class="info">
                                                                    <span class="title">Shivani Shah</span>
                                                                    <span class="sub-title">ID 10</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="mrg-top-15">
                                                                <span class="text-info"><b>10</b></span>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="mrg-top-15">
                                                                <span>16mscit101@gmail.com</span>
                                                            </div>
                                                        </td>
                                                         <td>
                                                            <div class="mrg-top-15">
                                                        ...
                                                        <td>
                                                            <div class="mrg-top-15">
                                                                <b class="text-dark font-size-16">789568422</b>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="mrg-top-10 text-center">
