                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-block" style="margin-top:100px;">
                                    ...
                                    <div style="margin-bottom:40px;"> <center><h2><b>:: View Orders ::</h2></b></center></div>
    <center>
...
while ($row = mysqli_fetch_array($result)) {
   ...
   $Dstatus=$row[8];
    ...
    echo "<tbody><tr align='center'><td>$row[0]</td><td>$row[2]</td></td><td>$row[3]</td><td>$row[4]</td>"
            . "<td>$row[5]</td><td>$row[6]</td>";
    
            if ($row[7] == 'Done') {

        echo "<td><a class='btn btn-default btn-sm' href='PaymentStatusPending.php?oid=$row[0]'><i  class='fas fa-check' style='color:green;'></i></td>";
    } else {

        echo "<td><a class='btn btn-default btn-sm' href='PaymentStatusDone.php?oid=$row[0]'><i class='fas fa-times' style='color:green ;'></i></td>";
    }
    
     if ($row[8] == 'Done') {

        echo "<td><a class='btn btn-default btn-sm' href='DeliveryPending.php?oid=$row[0]'><i  class='fas fa-check' style='color:green;'></i></td>";
    } else {

        echo "<td><a class='btn btn-default btn-sm' href='DeliveryDone.php?oid=$row[0]'><i class='fas fa-times' style='color:green ;'></i></td>";
    }
