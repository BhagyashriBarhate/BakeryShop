...
<!-- Mirrored from warethemes.com/html/bready/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Jan 2019 13:06:54 GMT -->
<head>
    <meta charset="utf-8">
...
?>
    ...
    <div id="contact-map" data-address="Gujarat, Adajan" data-title="Funiture!" data-zoom="17"></div>
        ...
        <div class="row">
          <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
            <form class="ps-form--contact" action="#" method="post">
              ...
              <div class="form-group">
                <label>Your Feedback <sup>*</sup></label>
                <textarea class="form-control" required="" name="message" rows="7"></textarea>
              </div>
              <div class="form-group submit">
<!--                <button class="ps-btn ps-btn--yellow">Submit</button>-->
                <input type="submit" name="submit" class="ps-btn ps-btn--yellow" value="Submit">
              </div>
            </form>
          </div>
          <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
            <div class="ps-contact__info">
              <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                    <div style="margin-left: 100px;" class="ps-block--contact-2">
                    <h3>OFFICE AT SURAT</h3>
                    <h4>BASEMENT COMPANY, ADAJAN</h4>
                    <p><i class="fa fa-envelope-o"></i><a href="#">HETVI@gmail.com</a></p>
                    <p><i class="fa fa-phone"></i> +91 960-171-2735</p>
                  </div>
                </div>
<!--                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                  <div class="ps-block--contact-2">
                    <h3>OFFICE AT AHMEDABAD </h3>
                    <h4>189/32 BASEMENT COMPANY</h4>
                    <p><i class="fa fa-envelope-o"></i><a href="#">BHAGYASHRI01@gmail.com</a></p>
                    <p><i class="fa fa-phone"></i> +1 650-253-0000</p>
                  </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                  <div class="ps-block--contact-2">
                    <h3>OFFICE AT GANDHINAGGAR</h3>
                    <h4>189/32 BASEMENT COMPANY</h4>
                    <p><i class="fa fa-envelope-o"></i><a href="#">yummyBakery@gmail.com</a></p>
                    <p><i class="fa fa-phone"></i> +91 988-953-1000</p>
                  </div>
                </div>-->
<!--                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                  <div class="ps-block--contact-2">
...
<!-- Mirrored from warethemes.com/html/bready/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Jan 2019 13:06:55 GMT -->
</html>
...
if(isset($_POST['submit'])){
      ...
      $message=$_POST['message'];
        ...
        $insert="insert into tbl_feedback(name,email,message) values('$name','$email','$message')";
