    ...
    <header class="header header--3" data-sticky="false">
      <div class="header__top">
        <div class="ps-container">
          <div class="left">
            <p>460 Harinagar Adajan Surat Gujarat: 960-171-2735 - 804-399-3580</p>
          </div>         
          </div>
        </div>
      </div>
      <nav class="navigation">
        <div class="ps-container"><a class="ps-logo" href="homepage-3.html"><img src="images/Yummy.png" alt=""></a>
          ...
          <div class="header__actions"><a class="ps-search-btn" href="#"><i class="ba-magnifying-glass"></i></a><a href="#"><i class="ba-profile"></i></a>
              <div class="ps-cart"><a class="ps-cart__toggle" href="Cart.php"><!--<span><i>20</i></span>--><i class="ba-shopping"></i></a>
              <div class="ps-cart__listing">
                ...
                <div class="ps-cart__total">
                  ...
                  <div class="ps-cart__footer"><a href="Checkout.php">Check out</a></div>
              </div>
            </div>
          </div>
             <ul class="menu">
              <li class="menu-item"><a href="homepage.php">Homepage</a></li>
              <li class="menu-item"><a href="customizeOrder.php">CUSTOMIZE ORDER</a></li>
              <li><a href="AboutUs.php">About</a></li>
              <li class="menu-item"><a href="Cake.php">OUR PRODUCT</a></li>
        ...
        <div class="ps-breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="active">Shop Page</li>
             <h2 style="color: black;n">Cookies</h2>
          </ol>
        </div>
      </div>
    </div>
    <main class="ps-shop">
      <div class="ps-shop__wrapper">
              ...
              <div class="ps-product__content"><a class="ps-product__title" href="product-detail.html"><?php echo "$row[1]" ?></a>
                <p><a href="product-list.html">Bakery</a> - <a href="product-list.html">Sweet</a> - <a href="product-list.html">Bio</a></p>
                  <div class="form-group--number"  >
                      <button class="minus" style="border-radius: 10px;"><span>-</span></button>
                      <input name="qty" class="form-control" style="border-radius: 10px;background-color: white;border: 1px solid black;" type="text" value="1">
                      <button class="plus" style="border-radius: 10px;"><span>+</span></button>
                    </div>
                <p class="ps-product__price"><?php echo "$row[3]"; ?> Rs/-</p>
                <input type="hidden" name="name" value="<?php $row[1] ?>">
                <input type="hidden" name="price" value="<?php $row[3] ?>">
       ...
       ?>
          ...
          <div class="ps-column">
            <div class="ps-product">
              <div class="ps-product__thumbnail"><img src="images/c5.jpg" alt=""><a class="ps-product__overlay" href="product-detail.html"></a>
                <ul class="ps-product__actions">
          ...
          <div class="ps-column">
            <div class="ps-product">
              <div class="ps-product__thumbnail"><img src="images/1.jpg" alt=""><a class="ps-product__overlay" href="product-detail.html"></a>
                <ul class="ps-product__actions">
                  <li><a href="#" data-tooltip="Quick View"><i class="ba-magnifying-glass"></i></a></li>
                  <li><a href="#" data-tooltip="Favorite"><i class="ba-heart"></i></a></li>
                  <li><a href="#" data-tooltip="Add to Cart"><i class="ba-shopping"></i></a></li>
      ...
      <aside class="ps-sidebar">
        <aside class="widget widget_sidebar widget_category">
          ...
          <ul class="ps-list--checked" >
            ...
            <li><a href="product-listing.html">Cake</a></li>
