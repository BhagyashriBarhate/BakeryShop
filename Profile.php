      ...
      <div class="ps-container">
       ...
       <form class="ps-form--menu" action="#" method="post"  enctype="multipart/form-data">
          <div class="ps-section__header text-center">
            <h3 class="ps-section__title">My Profile</h3>
        ...
        <i style='color:grey;' class="fas fa-user-circle fa-10x"></i>
         ...
         <?php 
           ...
           ?>
               ...
               <div class="form-group">
                <label>Email</label>
                <input  type="text" class="form-control"  value="<?php echo $row[3]; ?>"  name="email" readonly=""></textarea>
              </div>
               </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
            <div class="form-group">
                <label>Name</label>
                <input  type="text" class="form-control"  value="<?php echo $row[1]; ?>"   name="name"></textarea>
              </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
              <div class="form-group">
                <label>Contact</label>
                <input  type="text" class="form-control" value="<?php echo $row[4]; ?>"   name="contact"></textarea>
              </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
               <div class="form-group">
                <label>Address</label>
                <input  type="text" class="form-control"  value="<?php echo $row[6]; ?>"   name="address" ></textarea>
              </div>
            </div>
