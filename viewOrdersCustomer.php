            ...
            <table class="table ps-table ps-table--listing">
              <thead>
                ...
                include './conn.php';
                  ...
                  <?php
                $sql="SELECT product.image,product.pname,tbl_order.oid,tbl_order.TotalAmt,tbl_order.qty,tbl_order.Date
                    FROM product
                    INNER JOIN tbl_order
                    ON product.id=tbl_order.pid where tbl_order.uid=$id ";
                    $result= mysqli_query($conn, $sql);
...
<!--                    <td><a href='bill.php' class="ps-btn btn-yellow">Generate Bill </a></td>-->
        ...
        $sql1="select * from tbl_category ";
              ...
              <div class="form-group">
                  <a href="Cake.php?category_id=1"><button class="ps-btn ps-btn--gray">Continue Shopping</button></a>
              </div>
            </div>
